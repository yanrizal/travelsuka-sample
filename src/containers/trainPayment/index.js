...
class TrainPayment extends React.Component {
  ...
  handleOpenSeat = e => {
    history.push('/kereta-api/changeseat')
    // this.setState({
    //   openChangeSeat: true
    // })
  }
  ...
  handleOpenSeat2 = e => {
    history.push('/kereta-api/changeseat2')
    // this.setState({
    //   openChangeSeat: true
    // })
  }
  ...
  render() {
    ...
    return (
      <div>
              ...
              <div className="col-md-4">
                ...
                <div className="book-form price-detail-box">
                  ...
                  <div className="book-form pd-box" style={{boxShadow:'none',border:'1px solid rgba(204, 204, 204, 0.2)'}}>
                    {/*<p>Booking Code: <span className="pull-right" style={{fontWeight:'bold'}}>{bkSummary.bookingCode}</span></p>*/}
                    
                    <p>Transaction Id: <span className="pull-right">{bookingSummary.transactionId}</span></p>
                    <hr/>
                    {bkSummary.passengerDetails.map((contact) => {
                      let name2 = ''
                      if (contact.middleName !== "") {
                        const mn = contact.middleName.split(" ")
                        name2 = mn[0]
                      } else {
                      ...
                      <div>
                      {contact.paxType === 'ADT' &&
                      <p>{contact.firstName} {name2}<span className="pull-right">{contact.seatInfo[0].WagonId} {contact.seatInfo[0].WagonNo}/{contact.seatInfo[0].SeatNumber}{contact.seatInfo[0].SeatCode}</span></p>
                      }
                      {contact.paxType === 'INF' &&
                      <p>{contact.firstName} {name2}</p>
                      }
                      </div>
                    )}
                    )}
                    <p><span className="pull-right">
                    <a href="javascript:void(0);" onClick={this.handleOpenSeat}>Change Seat</a>
                    </span></p>
                    <div className="clear"></div>
                    <hr/>
                    <p>Adult Fare ({this.props.adultCount}x): <span className="pull-right">Rp {formatRp(bkSummary.basicFare)}</span></p>
                    <p>Discount Channel KAI:  <span className="pull-right">Rp {formatRp(bkSummary.bookingFee)}</span></p>
                    <p>Convenience Fee KAI:  <span className="pull-right">Rp {formatRp(-1*bkSummary.bookingFee)}</span></p>
                    {this.state.promoAdded &&
                ...
                <div className="book-form price-detail-box">
                 <div className="total-top">
                  ...
                  <div className="book-form pd-box">
                    {/*<p style={{marginBottom:10}}>Booking Code ({bkSummary.flightJourneys[0].departureAirport.code} - {bkSummary.flightJourneys[0].arrivalAirport.code}): <span className="pull-right" style={{fontWeight:'bold'}}>{bkSummary.bookingCode}</span></p>*/}
                    {bkSummary.passengerDetails.map((contact) => {
                      let name2 = ''
                      if (contact.middleName !== "") {
                        const mn = contact.middleName.split(" ")
                    ...
                    <div className="clear"></div>
                    <hr/>
                    {/*<p style={{marginBottom:10}}>Booking Code ({bkSummary2.flightJourneys[0].departureAirport.code} - {bkSummary2.flightJourneys[0].arrivalAirport.code}): <span className="pull-right" style={{fontWeight:'bold'}}>{bkSummary2.bookingCode}</span></p>*/}
                    {bkSummary2.passengerDetails.map((contact) => {
                      let name2 = ''
                      if (contact.middleName !== "") {
                        const mn = contact.middleName.split(" ")
                        name2 = mn[0]
                    ...
                    <p><span className="pull-right">
                    <a href="javascript:void(0);" onClick={this.handleOpenSeat2}>Change Seat</a>
                    </span></p>
                    <div className="clear"></div>
                    <hr/>
                    <p>Transaction Id: <span className="pull-right">{bookingSummary.transactionId}</span></p>
                 ...
                 <div className="clear"></div>
                   <div className="book-form" style={{marginTop:'40px'}}>
                    ...
                    {bkSummary.flightJourneys[0].flightSegments.map((flight, index) => (
                      ...
                      <div className="col-md-8 fl-book-detail">
                        {index == 0 &&
                          <h2>Pergi</h2>
                        }
                        <div>
        ...
        <Modal open={this.state.openChangeSeat} onClose={this.onCloseSeat} little showCloseIcon={false}>
          <ChangeSeat onChangeSeat={this.handleChangeSeat} />
        </Modal>
