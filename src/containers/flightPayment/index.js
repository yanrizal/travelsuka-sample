...
import { snapTokenRequest } from '../../modules/auth';
...
class FlightPayment extends React.Component {
  ...
  componentDidMount(){
    const { bookingSummary, selectedFlight } = this.props;
    console.log('bookingSummary', bookingSummary);
    console.log('selectedFlight', selectedFlight);
    window.scrollTo(0, 0);
    const taxNewPrice = bookingSummary.bookingsSummary[0].taxAndFee;
    const taxOldPrice = selectedFlight.flightSegments[0].fares[0].airportTax + selectedFlight.flightSegments[0].fares[0].iwjr;
    if (taxNewPrice !== taxOldPrice) {
      this.setState({
        open: true,
        errorMsg: `There is Tax Price change from Rp ${formatRp(taxOldPrice)} to Rp ${formatRp(taxNewPrice)}`,
      })
    }
    const self = this;
  ...
  handlePayment = e => {
    snap.pay('1a86ce61-dc8f-4082-88d1-c151b9bb2e2e', 
    {
              ...
              {this.props.twoway &&
                ...
                <div className="book-form price-detail-box" style={{marginBottom:'20px'}}>
                  ...
                  <div className="book-form pd-box" style={{boxShadow:'none',border:'1px solid rgba(204, 204, 204, 0.2)'}}>
                    ...
                    <p>Airport Tax:  <span className="pull-right">Rp {formatRp(bkSummary.taxAndFee)}</span></p>
                  </div>
                ...
                <div className="book-form price-detail-box">
                 <div className="total-top">
                  ...
                  <div className="book-form pd-box">
                    ...
                    <p>Airport Tax:  <span className="pull-right">Rp {formatRp(bkSummary2.taxAndFee)}</span></p>
                  </div>
                  <div className="total-bot">
